    ...
    <div className="bg-white text-black">
      ...
      <section className="relative w-full min-h-[50vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-5">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Tractors</h1>
          <p className="text-lg md:text-xl max-w-2xl mx-auto">
            Reliable farming equipment for cultivation, planting, and harvesting
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-5 py-16">
        <div className="text-center">
          <p className="text-lg text-gray-600">
            Our tractor collection is coming soon. Check back for detailed specifications, pricing, and availability.
          </p>
        </div>
      </section>
